...
const Blogs = () => {
    return (
        <div className=' shadow qna py-5 px-5 lg:px-20 flex flex-col gap-10'>
            <h1 className='text-4xl font-bold underline mb-6 mt-6 text-center'>Questions  and Answer </h1>

            <div className='mb-12'>
            <div>
                <h1 className='text-2xl font-bold text-neutral py-4'>How will you improve the performance of a React Application?
                </h1>
            ...
            <div>
                <h1 className='text-2xl font-bold text-neutral py-3'>How does prototypical inheritance work?
                </h1>
                <p className='text-justify'>
